...
| `AuditAction` | `publish`, `approve`, `reject`, `delete`, `login`, `login_failed`, `access_denied`, `role_change`, `ai_generate`, `export`, `state_change`, `assign`, `content_update`, `ai_config_update` | Auditoría inmutable. `access_denied` (GTK-68) intentos de ruta admin sin permiso; `state_change`/`assign` (GTK-35) CRM; `content_update` (GTK-41) edición CMS; `ai_config_update` (GTK-37) presupuesto IA. |
