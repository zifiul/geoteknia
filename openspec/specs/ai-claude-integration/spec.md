# ai-claude-integration Specification

## Purpose

Cliente Claude server-only con retries, timeout, prompt caching, streaming y cálculo de coste EUR para alimentar el ledger `ai_token_usage`. Materializa GTK-36 (RF-19 / RNF-IA); consumido por GTK-38.
