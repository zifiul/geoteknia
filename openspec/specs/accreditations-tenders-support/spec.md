# accreditations-tenders-support Specification

## Purpose

Entidades de solvencia para obra pública: credenciales corporativas (`accreditations`), clasificación de contratista (`contractor_classifications`) y experiencia con organismos públicos (`public_organism_experience`). Materializa GTK-8, RF-12, RF-15 y `docs/technical/data-model.md` §4.8.
