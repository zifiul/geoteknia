...
Primitiva de autorización del portal interno: comprobación de permiso atómico por rol y de pertenencia de recurso para el rol `tecnico`, consumida por Server Actions y Route Handlers. Materializa GTK-25 sobre la sesión de `portal-auth-credentials` (GTK-23) y la matriz de `rbac-identity-audit` (GTK-7/GTK-17).
