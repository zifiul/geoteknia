# rbac-identity-audit Specification

## Purpose

Núcleo de identidad, RBAC y auditoría append-only del portal interno: roles, permisos, usuarios, sesiones y audit log. Materializa GTK-7 y `docs/technical/data-model.md` §4.2. Prerrequisito para entidades con bloque AUDIT y seed RBAC (DB-14).
