# admin-crm-project-detail-ui

## Purpose

UI del portal admin para la ficha interactiva de un proyecto CRM (`/admin/proyectos/[id]`), consumiendo lecturas GTK-34 y Server Actions GTK-35.
