# local-container-environment Specification

## Purpose

Orquestación Docker Compose de PostgreSQL y aplicación Next.js para desarrollo local y CI de Geoteknia, con migraciones, seed, healthchecks y comandos documentados de arranque/parada/reset.
