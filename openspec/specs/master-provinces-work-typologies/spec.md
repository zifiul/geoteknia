# master-provinces-work-typologies Specification

## Purpose

Catálogos maestros transversales de provincias/CCAA operativas (`provinces`) y tipologías de obra (`work_typologies`). Materializa GTK-10 y `docs/technical/data-model.md` §4.1. Prerrequisito para geo-landings, casos, leads, proyectos, calculadora y páginas servicio×zona.
