# ai-token-accounting Specification

## Purpose

Ledger append-only de tokens consumidos y coste en EUR por invocación a Claude, agregable por período de facturación. Materializa GTK-16 y RNF-IA (control de coste).
...
- **THEN** operación es permitida por Prisma pero constituye violación de contrato (append-only) y tests unitarios detectan intentos
