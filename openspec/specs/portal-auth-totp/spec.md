# portal-auth-totp Specification

## Purpose

Segundo factor TOTP del portal `/admin`: generación y verificación de códigos, cifrado del secreto en reposo, verificador de login y gestión self-service (GTK-24).
