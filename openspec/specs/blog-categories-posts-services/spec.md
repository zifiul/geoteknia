# blog-categories-posts-services Specification

## Purpose

Centro de conocimiento geotécnico: categorías editoriales (`blog_categories`), artículos con autoría E-E-A-T (`blog_posts`) y linking interno hacia servicios pillar (`blog_post_services`). Materializa GTK-13, RF-06 y `docs/technical/data-model.md` §4.6.
