# faqs-lead-magnets-calculator-rules Specification

## Purpose

Entidades de conversión y soporte SEO de cola larga: agrupaciones y preguntas FAQ (`faq_groups`, `faqs`), recursos descargables gated (`lead_magnets`) y reglas configurables de la calculadora de alcance CTE (`calculator_rules`). Materializa GTK-15 y `docs/technical/data-model.md` §4.7. Aporta datos estructurados `FAQPage`, captación de leads y orientación del alcance geotécnico sin hardcodear el cálculo.
