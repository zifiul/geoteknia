# public-location-widget Specification

## Purpose

Widget flotante de microconversión «enviar ubicación de la parcela» (GTK-65): referencia catastral o coordenadas del navegador, contacto mínimo, Turnstile, tracking `send_location` y consumo del API GTK-29.
