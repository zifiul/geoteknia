# public-blog-listing Specification

## Purpose

Índice público `/blog` y listados por categoría `/blog/[categoria]` con paginación SEO-friendly, navegación de categorías y tarjetas de artículo. Materializado con GTK-54; artículo individual en `public-blog-article` (GTK-55).
