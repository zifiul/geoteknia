# public-calculadora-page Specification

Página pública `/calculadora` y widget interactivo de estimación de alcance geotécnico (GTK-64). Consume `POST /api/calculadora` (GTK-33) y enlaza a `/presupuesto` con pre-relleno.
