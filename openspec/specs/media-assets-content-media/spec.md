# media-assets-content-media Specification

## Purpose

Repositorio central de activos multimedia (`media_assets`) y galería polimórfica (`content_media`) para contenido publicable. Materializa GTK-9 y `docs/technical/data-model.md` §4.3.
