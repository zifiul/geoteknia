# admin-cms-list Specification

## Purpose

Listado editorial del portal CMS en `/contenido`: filtros por tipo, estado y silo, métricas de workflow, paginación y acciones según RBAC (GTK-72).
