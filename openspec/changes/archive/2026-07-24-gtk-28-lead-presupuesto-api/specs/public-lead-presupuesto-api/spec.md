# public-lead-presupuesto-api — Delta (GTK-28)
...
El sistema SHALL generar `reference_number` con formato `PRE-YYYYMMDD-XXXX` (alfanumérico sin `O/0/I/1`) y reintentar hasta 5 veces ante colisión de unicidad dentro de la transacción.
