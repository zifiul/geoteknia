# Delta spec — public-front-scaffolding

> Origen: GTK-43 — Bootstrap del frontal Next.js 15
...
- **THEN** el HTML renderizado refleja el estilo asociado tras `npm run build`
