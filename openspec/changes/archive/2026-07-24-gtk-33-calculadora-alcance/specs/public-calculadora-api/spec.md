...
> Delta spec — US: [GTK-33](https://linear.app/geoteknia/issue/GTK-33/post-apicalculadora-calculadora-de-alcance-de-estudio-geotecnico)
> Consume: `calculator_rules` (GTK-15/17), catálogos provincias/tipologías (GTK-10), `recordConversionEvent` (GTK-32).
