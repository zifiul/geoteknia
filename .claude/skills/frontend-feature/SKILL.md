...
Guía la implementación frontend de una US dentro del harness: desde el contrato congelado y los tests en RED hasta la UI en verde, sin desviarse de `docs/technical/frontend-standards.md` (fuente de verdad; esta skill ordena el trabajo, no lo duplica).
...
- `design.md` del change y `frontend-standards.md` (secciones de App Router, Atomic Design, SEO, formularios, a11y).
...
3. **Construye mobile-first:** maqueta primero el viewport móvil con los tokens del sistema (`styles/tokens.css` o equivalente — nunca valores arbitrarios), amplía después a tablet/desktop. Toda interacción funciona con touch y teclado.
...
- Colores/espaciados hardcodeados en lugar de tokens.
