...
export default function MachineryError({
  reset,
}: {
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-16 text-center">
      <h1 className="font-display text-2xl font-semibold text-brand-on-surface">
        No hemos podido cargar el equipamiento
      </h1>
      <p className="mt-3 text-sm text-muted">
        Ha ocurrido un error al obtener la maquinaria. Puedes reintentar o volver al inicio.
      </p>
