...
export type SiteNavContactProps = {
  phone: string | null;
    ...
    <div className="hidden shrink-0 items-center gap-1 lg:flex">
      ...
      {whatsappHref ? (
        <ContactTrackLink
          ...
          className={cn(
            'inline-flex min-h-11 min-w-11 items-center gap-2 rounded-sm px-2 text-sm text-brand-on-surface underline-offset-2 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent',
          )}
        >
          <WhatsAppIcon />
          <span>WhatsApp</span>
